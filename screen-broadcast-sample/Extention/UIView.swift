...
extension UIView {
    func anchor(top: NSLayoutYAxisAnchor? = nil,
        ...
        if let lessThanWidth = lessThanWidth {
            widthAnchor.constraint(lessThanOrEqualToConstant: lessThanWidth).isActive = true
        }
